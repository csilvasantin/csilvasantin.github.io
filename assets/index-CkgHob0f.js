      ...
      <main class="page" id="inicio">
        ...
        <section class="closing-panel">
          ...
          <div class="closing-actions">
            <a class="button button-primary" href="/diario/">Abrir diario publico</a>
