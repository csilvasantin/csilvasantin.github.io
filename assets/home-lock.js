(function () {
  ...
  function renderCustomButton() {
    ...
    btn.addEventListener("click", initAndPrompt);
    btnContainer.appendChild(btn);
  }

  // No llamamos a google.accounts.id.initialize hasta que el usuario pulse el boton
  window.onGoogleLibraryLoad = renderCustomButton;
  renderCustomButton();
})();
